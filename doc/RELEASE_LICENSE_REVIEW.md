# 0.1.0-rc.1 个人开发者许可审查

本候选保留在 private 仓库的 Draft Release。公开发布状态：**待权属确认**。审查责任人为个人维护者 BLANK2077；不设置公司法务或组织审批流程。
...
不分发 Synopsys 安装目录、库、头文件、手册或 license 凭据。个人开发身份并不自动解除第三方分发义务。未关闭以上事项时只能用于本 private 候选审查，不能把 Draft 直接改为公开正式发布。
