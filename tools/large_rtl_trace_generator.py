...
def render(target_lines: int) -> tuple[str, dict[str, object]]:
    ...
    metadata: dict[str, object] = {
        ...
        "query_anchors": {
            "resolve": "top.large_trace_top.u_leaf_00000.payload",
            "value": "TOP.large_trace_top.u_leaf_00000.leaf_out",
            "driver": "top.large_trace_top.u_leaf_00000.leaf_out",
            "active_driver": "top.large_trace_top.u_leaf_00000.bus.data",
            "active_chain": "top.large_trace_top.u_sink_00000.observed",
            "changes": "TOP.large_trace_top.u_leaf_00000.state",
            "query_time": "350ps",
            "changes_begin": "0ps",
            "changes_end": "470ps",
        },
