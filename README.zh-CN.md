...
首版提供 Linux x86_64 完整预编译包。目标运行平台为 EL8、Ubuntu 22.04/24.04；各候选版本的实际验收结果见随包报告。正式版本及完整附件见 [GitHub Releases](https://github.com/BLANK2077/xdebug_fst/releases)。
...
自有新增代码采用 [BSD-3-Clause](LICENSE)，第三方来源与分发边界见 [THIRD_PARTY.md](THIRD_PARTY.md)。贡献与问题反馈见 [CONTRIBUTING.md](CONTRIBUTING.md)。
