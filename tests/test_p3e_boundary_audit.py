...
def test_p3e_boundary_audit_is_reproducible_and_repository_local() -> None:
    audit = load_audit()
    assert build_frozen_audit(ROOT, MANIFEST) == audit
